...
local function syncBagState(forceRefreshWeapons)
    local hasBag = Utils.isWearingBag(cache.ped)

    if forceRefreshWeapons or playerState.has_back_bag ~= hasBag then
        playerState:set('has_back_bag', hasBag, true)
